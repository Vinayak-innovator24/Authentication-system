It's a user authentication and management application with the following endpoints:
...
4. Update User details - Accept new user details fields to update and store the updated data in an encrypted format. Data has to be encrypted in transit and when it is                          received at the backend, it has to be decrypted. 


Postman documentation link : https://documenter.getpostman.com/view/20862445/2s93CKNtw1
